...
<head>
    ...
    <title>Admin Panel - KARYANYATA.ID</title>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Grafik Penjualan
                                    </span></a>
                                <ul class="collapse">
                                    <li><a href="grafik_bulanan.php">Customer Perbulan</a></li>
                                    <li><a href="grafik_pie.php">Penjualan tiap Produk</a></li>
