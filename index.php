	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>CINTAI KARYA INDONESIA, CINTAI  KARYANYATA !</p>
			</div>
			<div class="agile-login">
				...
				if(!isset($_SESSION['log'])){
					...
					echo '
					<li style="color:#1BA098">Halo, '.$_SESSION["name"].'
...
<!-- //navigation -->
	...
	<div class="top-brands">
		<style>
			background-image: url('images/zoom.webp');</style>
		<div class="container">
		<h2>Produk Kami</h2>
